...
window.jQuery = function (selectorOrArray) {
  ...
  console.log("我是jQuery"); //     const api = { //api是jQuery构造出来的一个对象
  ...
  return {
    ...
    children: function children() {
      var array = [];
      this.each(function (node) {
        array.push.apply(array, _toConsumableArray(node.children)); //...是展开操作符,意思是把数组拆开,第n个元素当第n个参数
      });
      return jQuery(array);
    }
  };
...
},{}]},{},["C:/Users/PC/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","jquery.js"], null)
